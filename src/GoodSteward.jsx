  ...
  if (isDesktop) {
    ...
    return (
      <div style={{ minHeight:"100dvh", background:C.bg, fontFamily:sans }}>
        <FontInjector />
        <header style={{ position:"sticky", top:0, zIndex:10, background:"#F3EEE2", borderBottom:`1px solid ${C.line}` }}>
...
// An editorial section marker: a roman numeral, a hairline, and a small label. This
// replaces the centered uppercase kicker that every generated landing page uses.
function SectionMark({ n, label }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
      <span style={{ fontFamily: serif, fontSize: 13, fontWeight: 600, color: C.brass, letterSpacing: "0.08em" }}>{n}</span>
      <span style={{ height: 1, width: 28, background: C.line }} />
      <span style={{ fontFamily: sans, fontSize: 12, letterSpacing: "0.16em", textTransform: "uppercase", color: C.muted, fontWeight: 600 }}>{label}</span>
    </div>
  );
}
...
function LandingPage({ onStart, onTrust }) {
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100dvh", fontFamily: sans, color: C.ink }}>
      ...
      {/* Editorial hero: light falls from the upper left, type is set flush left on a
          two-column measure. Deliberately NOT a centered stack with a glow behind it —
          that composition is the giveaway of a generated page. */}
      <header style={{ background: `linear-gradient(158deg, ${C.pineSoft} 0%, ${C.pine} 46%, #14271F 100%)`, color: "#F3EEE2", position: "relative", overflow: "hidden" }}>
        <Grain />
        <div style={{ ...wrap, position: "relative", zIndex: 1, padding: "clamp(64px,11vw,132px) 24px clamp(56px,9vw,104px)" }}>
          <div style={{ display: "flex", alignItems: "baseline", gap: 14, marginBottom: 26 }}>
            <span style={{ height: 1, width: 46, background: C.brass, opacity: 0.8, transform: "translateY(-4px)" }} />
            <p style={{ fontFamily: sans, fontSize: 12.5, letterSpacing: "0.2em", textTransform: "uppercase", color: C.brassSoft, margin: 0 }}>A stewardship layer for your money</p>
          </div>
          <h1 style={{ fontFamily: serif, fontWeight: 500, fontSize: "clamp(44px,8.4vw,96px)", lineHeight: 0.99, margin: 0, letterSpacing: "-0.033em", maxWidth: "14ch" }}>
            Money is <em style={{ color: C.brassSoft, fontStyle: "italic" }}>stored&nbsp;agency.</em>
          </h1>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: "clamp(20px,4vw,56px)", alignItems: "end", marginTop: "clamp(28px,4vw,44px)" }}>
            <p style={{ fontFamily: sans, fontSize: "clamp(16px,1.7vw,18.5px)", lineHeight: 1.62, color: "#D9D2C2", margin: 0, maxWidth: "46ch" }}>
              Round up your spare change and invest it to reduce foreseeable harm — by your own
              values — then redirect the unavoidable residue toward human flourishing.
            </p>
            <div>
              {cta("Open your account")}
              <p style={{ fontFamily: sans, fontSize: 12.5, color: "#9FB3A4", margin: "16px 0 0", lineHeight: 1.5 }}>No claim of moral purity.<br />Ethical investing is asymptotic.</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <section style={{ ...wrap, padding: "clamp(56px,8vw,90px) 24px" }}>
        <SectionMark n="I" label="How it works" />
        <h2 style={{ fontFamily: serif, fontSize: "clamp(30px,4.6vw,48px)", fontWeight: 500, color: C.pine, margin: "0 0 10px", letterSpacing: "-0.025em", maxWidth: "18ch", lineHeight: 1.05 }}>Three moves, quietly, in the background.</h2>
        <p style={{ fontFamily: sans, fontSize: 16.5, color: C.muted, maxWidth: "52ch", margin: "0 0 44px", lineHeight: 1.6 }}>You spend as you always do. Steward turns the remainder into a small, deliberate act.</p>
      ...
      <section style={{ background: C.card, borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}` }}>
        <div style={{ ...wrap, padding: "clamp(56px,8vw,90px) 24px" }}>
          <SectionMark n="II" label="Invest by what you believe" />
          <h2 style={{ fontFamily: serif, fontSize: "clamp(30px,4.6vw,48px)", fontWeight: 500, color: C.pine, margin: "0 0 40px", letterSpacing: "-0.025em", maxWidth: "16ch", lineHeight: 1.05 }}>A marketplace of moral frameworks.</h2>
      ...
      {/* Pull-quote set as print would: flush left, oversized, with a hanging quotation
          mark in the margin. The one moment on the page that's allowed to be loud. */}
      <section style={{ ...wrap, padding: "clamp(72px,10vw,128px) 24px", maxWidth: 940 }}>
        <div style={{ position: "relative", paddingLeft: "clamp(0px,3vw,54px)" }}>
          <span aria-hidden="true" style={{ position: "absolute", left: "clamp(-6px,-0.6vw,0px)", top: "clamp(-26px,-2.4vw,-10px)", fontFamily: serif, fontSize: "clamp(76px,11vw,150px)", lineHeight: 1, color: C.brass, opacity: 0.26, pointerEvents: "none", userSelect: "none" }}>&ldquo;</span>
          <blockquote style={{ fontFamily: serif, fontStyle: "italic", fontWeight: 500, fontSize: "clamp(24px,3.9vw,42px)", lineHeight: 1.28, color: C.pine, margin: 0, letterSpacing: "-0.022em", position: "relative" }}>
            Minimize foreseeable harm, preserve practical effectiveness, and direct the
            unavoidable residue toward the common good.
          </blockquote>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 26 }}>
            <span style={{ height: 1, width: 34, background: C.line }} />
            <p style={{ fontFamily: sans, fontSize: 15, color: C.muted, margin: 0, lineHeight: 1.62, maxWidth: "58ch" }}>
              We name the residue rather than hide it. A monthly statement gives you a fuller
              account than &ldquo;you made 8.2%&rdquo; — wealth, impact, and restoration, side by side.
            </p>
          </div>
        </div>
      </section>
